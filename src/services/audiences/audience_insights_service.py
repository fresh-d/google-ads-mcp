...
class AudienceInsightsService:
    ...
    async def generate_insights_finder_report(
        ...
        try:
            ...
            # User interests: v23 uses topic_audience_combinations (OR within one group)
            if specific_audience_user_interests:
                interest_group = InsightsAudienceAttributeGroup()
                for interest_id in specific_audience_user_interests:
                    ...
                    interest_group.attributes.append(attr)
                specific_audience.topic_audience_combinations.append(interest_group)
            ...
            # Note: In v23, GenerateInsightsFinderReportRequest doesn't have dimensions field
    ...
    async def generate_audience_composition_insights(
        ...
        try:
            ...
            # Note: In v23, user interests should be provided through topic_audience_combinations
